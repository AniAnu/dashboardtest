...
! function() {
    ...
    e.$inject = ["$urlRouterProvider", "baSidebarServiceProvider"], angular.module("BlurAdmin.pages", ["ui.router", "BlurAdmin.pages.dashboard", "BlurAdmin.pages.form", "BlurAdmin.pages.collaboration", "BlurAdmin.pages.contacts", "BlurAdmin.pages.charts", "BlurAdmin.pages.administration", "BlurAdmin.pages.profile", "BlurAdmin.pages.SmartLibrary", "BlurAdmin.pages.SmartDocument"]).config(e)
}(),
