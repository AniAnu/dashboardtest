...
<table class="table table-bordered table-hover table-condensed">
    <tr>
	       ...
	       <th><?php echo __('titre'); ?></th>
			...
			<th><?php echo __('Sectors'); ?></th>
			<th><?php echo __('Clientels'); ?></th>
...
<?php $i=1; foreach ($composants as $Composant): ?>
    <tr>
        <td><?php echo $i++; ?></td>
        <td>
        	<input type="text" class="form-control input-lg input_lg" disabled="disabled" value="<?php echo h($Composant['Composant']['titre']); ?>" style="cursor: initial;" 
        	id="titre<?php echo h($Composant['Composant']['id']); ?>">
        </td>
        <td>
        	<textarea  class="form-control input-lg input_lg" disabled="disabled" style="cursor: initial;margin: 0px;width: 193px;height: 46px;padding: 0px;"
...
<option><?php echo $value['TypeComponent']['description'];?></option>
    ...
    <?php endforeach; ?>
     <tr style="display:none2" id="trnew">
        <td></td>
          <td>
        	<input type="text" class="form-control input-lg input_lg"  value="" style="cursor: initial;" id="titre0">
        </td>
        <td>
        	<textarea class="form-control input-lg input_lg" required style="margin: 0px;width: 193px;height: 46px;padding: 0px;" id="description0">
