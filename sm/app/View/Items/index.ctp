...
<?php $i=1; foreach ($items as $Item): ?>
    <tr>
        <td><?php echo $i++; ?></td>
        <td>
        	<input type="text" class="form-control input-lg input_lg" disabled="disabled" value="<?php echo h($Item['Item']['name']); ?>" style="cursor: initial;" 
        	id="name<?php echo h($Item['Item']['id']); ?>">
        </td>
        <td>
        	<input type="text" class="form-control input-lg input_lg" disabled="disabled" value="<?php echo h($Item['Item']['price']); ?>" style="cursor: initial;" 
        	id="price<?php echo h($Item['Item']['id']); ?>">
        </td>
        <td>
        	<input type="text" class="form-control input-lg input_lg" disabled="disabled" value="<?php echo h($Item['Item']['description']); ?>" style="cursor: initial;" 
