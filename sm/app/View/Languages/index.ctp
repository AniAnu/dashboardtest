...
<?php $i=1; foreach ($languages as $Language): ?>
    <tr>
        <td><?php echo $i++; ?></td>
        <td>
        	<input type="text" class="form-control input-lg input_lg" disabled="disabled" value="<?php echo h($Language['Language']['name']); ?>" style="cursor: initial;" 
        	id="name<?php echo h($Language['Language']['id']); ?>">
        </td>
        
        	<td><input type="text" class="form-control input-lg input_lg" disabled="disabled" value="<?php echo h($Language['Language']['abbreviation']); ?>" style="cursor: initial;" 
