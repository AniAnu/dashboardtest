...
<body>
<div class="header">Planification </div>
...
<input name="ref" type="text" list="query" class="form-control input-lg" placeholder="Enter your Numero cellule">
<input  name="email" class="form-control input-lg" placeholder="Enter your Email">
<input name="name" class="form-control input-lg" placeholder="Enter your name">
<button class="form-control input-lg">Envoyer</button>
</div>
<div class="col-md-6 contact">
  <textarea class="form-control input-lg" rows="8" name="message">Message...
  </textarea></div>
</form>
</body>
